...
function nationalPhoneNumber(phoneNumber, kodeNegara) {
  try {
...
module.exports = nationalPhoneNumber;
...
// const validationMessage = nationalPhoneNumber(phoneNumber, kodeNegara);
